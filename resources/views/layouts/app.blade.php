...
>
    <div class="fixed inset-0 z-30 bg-slate-900/50 backdrop-blur-sm lg:hidden" x-show="sidebarOpen" x-transition.opacity @click="sidebarOpen = false" x-cloak></div>
    ...
    <div class="flex min-h-screen flex-col lg:pl-64">
        <main class="flex-1 p-4 sm:p-6 lg:p-8">
            ...
            <x-admin.top-bar :title="$header ?? 'CoachPro+'" :subtitle="$subtitle ?? null">
                @isset($action)
